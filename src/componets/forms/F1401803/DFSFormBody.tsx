import { DFSFormRowType } from "../../../utils/DFSXMLForm";

export interface DFDFormBodyProps {
  rows?: Array<DFSFormRowType>;
}

export function DFSFormBody(props: DFDFormBodyProps) {
  const { rows } = props;
